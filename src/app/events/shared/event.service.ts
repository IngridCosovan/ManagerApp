...
export class EventService {
  ...
  updateEvent(event: any) {
    ...
    EVENTS[index] = event;
    //Va gasi eventul cu acel idex si il va inlocui
  }
...
const EVENTS: IEvent[] = [
  {
    ...
    time: '10:00 am',
    price: 599.99,
    imageUrl: '/assets/images/angular-connect.svg',
    location: {
      address: '1057 DT',
      city: 'London',
      country: 'England'
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 950.00,
    imageUrl: '/assets/images/ng-nl.svg',
    // location: {
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 759.00,
    imageUrl: '/assets/images/ng-conf.svg',
    location: {
  ...
  },
  {
    ...
    time: '8:00 am',
    price: 800.00,
    imageUrl: '/assets/images/basic-shield.svg',
    // location: {
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 400.00,
    imageUrl: '/assets/images/ng-vegas.svg',
    location: {
      address: 'The Excalibur',
      city: 'Las Vegas',
      country: 'USA'
    },
    onlineUrl: 'http://ng-vegas.org/',
    sessions: [
      {
        id: 1,
